...
void vector_add_SIMD(const int* a, const int* b, int* result, int n) {
    for (int i = 0; i < n; i += 32) {
        v8i va0 = _mm256_loadu_si256((const v8i*)(a + i));
        v8i va1 = _mm256_loadu_si256((const v8i*)(a + i + 8));
        v8i va2 = _mm256_loadu_si256((const v8i*)(a + i + 16));
        v8i va3 = _mm256_loadu_si256((const v8i*)(a + i + 24));
        
        v8i vb0 = _mm256_loadu_si256((const v8i*)(b + i));
        v8i vb1 = _mm256_loadu_si256((const v8i*)(b + i + 8));
        v8i vb2 = _mm256_loadu_si256((const v8i*)(b + i + 16));
        v8i vb3 = _mm256_loadu_si256((const v8i*)(b + i + 24));
        
        _mm256_storeu_si256((v8i*)(result + i),      _mm256_add_epi32(va0, vb0));
        _mm256_storeu_si256((v8i*)(result + i + 8),  _mm256_add_epi32(va1, vb1));
        _mm256_storeu_si256((v8i*)(result + i + 16), _mm256_add_epi32(va2, vb2));
        _mm256_storeu_si256((v8i*)(result + i + 24), _mm256_add_epi32(va3, vb3));
    }
}
...
int main() {
    ...
    cout << "Testing vector addition with " << N << " elements (AVX2 256-bit unrolled 4x)\n";
