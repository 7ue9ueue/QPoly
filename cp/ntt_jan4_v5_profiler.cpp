...
inline v8i reduce(v8i x0246, v8i x1357) {
    ...
    v8i x0246_prod = _mm256_mul_epu32(x0246_ninv, v_mod);
    v8i x1357_prod = _mm256_mul_epu32(x1357_ninv, v_mod);
    v8i x0246_res = _mm256_add_epi64(x0246, x0246_prod);
    v8i x1357_res = _mm256_add_epi64(x1357, x1357_prod);
