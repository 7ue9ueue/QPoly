...
inline v8i mul_b_fixed(v8i a, v8i b, v8i bninv) {
    v8i cc = _mm256_mul_epu32(a, bninv);
    v8i dd = _mm256_mul_epu32(lmove(a), bninv);
    v8i c=_mm256_mul_epu32(a,b);
    d=_mm256_mul_epu32(lmove(a),b_only_even?b);
    cc=_mm256_mul_epu32(cc,M);=_mm256_mul_epu32(dd, v_mod);
