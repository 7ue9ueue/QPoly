...
// Constants
// ============================================================================
// Global constexpr integers for immediate operand optimization where possible
...
// Global const vectors. The compiler can load these efficiently (often keeping
// them in registers for loops) without passing them as arguments.
...
// Vector helpers using global constants
...
Root precomputation:        563177 ns
DIF nested loops:          4560343 ns
DIF small loops:           1701722 ns
Pointwise multiply:         257958 ns
DIT small loops:            825178 ns
DIT nested loops:          2312140 ns
----------------------------------------
Total (Breakdown Sum):    10220520 ns
========================================
